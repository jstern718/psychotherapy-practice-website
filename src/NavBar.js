                    ...
                    <div className="collapse navbar-collapse ml-n4 p-6 bg-dark" id="navbarNav">
                        <ul className="navbar-nav ms-auto">
                            <li className="nav-item m-1">
                                <NavLink to="/" className="hamburger-text m-3">
                                    Home
                                </NavLink>
                            </li>
                            <hr/>
                            <li className="nav-item m-1">
                                <NavLink to="About" className="hamburger-text"> About Me </NavLink>
                            </li>
                            <hr/>
                            <li className="nav-item m-1">
                                <NavLink to="/Resources" className="hamburger-text"> Resources </NavLink>
                            </li>
                            <hr/>
                            <li className="nav-item m-1">
                                <NavLink to="/Speaking" className="hamburger-text">
                                    Public Speaking
                                </NavLink>
                            </li>
                            <hr/>
                            <li className="nav-item m-1">
                                <NavLink to="/Contact" className="hamburger-text">
                                    Contact
                                </NavLink>
                            </li>
                        </ul>
